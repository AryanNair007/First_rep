...
def New_Download(index,times):
    ...
    print(soup)
    image_box=soup.find('a', {'href' :"20220620.html"})
    print("\n\t",image_box)
...
def image_show(destination,filetype):
    im=Image.open("{}.{}".format(destination))
...
source ='C:\\Users\\ashna\\OneDrive\\Desktop\\programs files\\pic_of _day\\demo\\'
